...
parser.add_argument('--detect_size', action='store_false', help='Use expected file sizes to map between old and new naming schemes.')
parser.add_argument('--log_changes', action='store_false', help='Create a .log file in each scan type folder noting the moving and renaming of files and the current date, named according to --log_name.')
parser.add_argument('--log_errors', action='store_false', help='Create a .log file noting any files not correctly renamed and moved.')
...
parser.add_argument('--verbose', action='store_false', help='Print progress updates while running, after each file is moved and renamed.')
